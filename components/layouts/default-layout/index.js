...
export default function DefaultLayout({ className, title, description, children, showSubFooter, isNavDark, showBackButton, invertMenuColours, setMixBlend, spinningLogoClassName }){
    return (
        <>
            <MobileView />
