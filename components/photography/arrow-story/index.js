...
const ArrowStory = ({ title, className }) => {
    return (
        <div className="relative self-center">
            <div className={ classNames( "hover:opacity-0 absolute duration-500 ", className) }>
            ...
            <div className="flex rounded-full w-[320px] h-[320px] bg-accent font-story">
                <p className="m-auto text-center text-secondary text-2xl">{title}</p>
            </div>
        </div>
    )
}
