...
const GalleryReel = ({ photographyReel }) => {
    ...
    return (
        <div className='-rotate-[25deg] -translate-y-[350px] -translate-x-[220px] grid grid-cols-6 gap-[14px] min-w-[250%] h-[70vh] breakpoint-iv:h-[100vh] breakpoint-iv:gap-6 breakpoint-iv:min-w-[150%] breakpoint-vii:min-w-[175%]'>
